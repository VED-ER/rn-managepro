...
const InputPrimaryPressable = ({ value, onPress, placeholder, style, inputStyle, IconRight, onIconRightPress, ...other }) => {
    ...
    return (
        <Pressable onPress={onPress} pointerEvents={'box-only'} style={({ pressed }) => ([style, pressed && { opacity: 0.5 }])}>
...
export default InputPrimaryPressable
